...
export const regions: Region[] = [
  ...
  // --- VICTORIA ---
  { name: "Yarra Valley, VIC", state: "Victoria", country: "Australia", center: { lat: -37.74, lng: 145.43 } },
  { name: "Mornington Peninsula, VIC", state: "Victoria", country: "Australia", center: { lat: -38.33, lng: 144.96 } },
  { name: "Geelong, VIC", state: "Victoria", country: "Australia", center: { lat: -38.11, lng: 144.42 } },
  { name: "Sunbury, VIC", state: "Victoria", country: "Australia", center: { lat: -37.59, lng: 144.69 } },
  { name: "Macedon Ranges, VIC", state: "Victoria", country: "Australia", center: { lat: -37.34, lng: 144.64 } },
  { name: 'Murray Darling, VIC', state: 'Victoria', country: 'Australia', center: { lat: -34.44, lng: 142.33 } },
  { name: 'Swan Hill, VIC', state: 'Victoria', country: 'Australia', center: { lat: -35.38, lng: 143.59 } },
  { name: 'Heathcote, VIC', state: 'Victoria', country: 'Australia', center: { lat: -36.97, lng: 144.69 } },
  { name: 'Bendigo, VIC', state: 'Victoria', country: 'Australia', center: { lat: -36.87, lng: 144.33 } },
  { name: 'Goulburn Valley, VIC', state: 'Victoria', country: 'Australia', center: { lat: -36.55, lng: 145.26 } },
  { name: 'Strathbogie Ranges, VIC', state: 'Victoria', country: 'Australia', center: { lat: -36.91, lng: 145.35 } },
  { name: "Upper Goulburn, VIC", state: "Victoria", country: "Australia", center: { lat: -37.21, lng: 145.63 } },
  { name: 'Rutherglen, VIC', state: 'Victoria', country: 'Australia', center: { lat: -36.06, lng: 146.45 } },
  { name: 'King Valley, VIC', state: 'Victoria', country: 'Australia', center: { lat: -36.72, lng: 146.30 } },
  { name: 'Alpine Valleys, VIC', state: 'Victoria', country: 'Australia', center: { lat: -36.69, lng: 146.83 } },
  { name: 'Beechworth, VIC', state: 'Victoria', country: 'Australia', center: { lat: -36.35, lng: 146.67 } },
  { name: 'Glenrowan, VIC', state: 'Victoria', country: 'Australia', center: { lat: -36.46, lng: 146.23 } },
  { name: 'Pyrenees, VIC', state: 'Victoria', country: 'Australia', center: { lat: -37.13, lng: 143.41 } },
  { name: 'Grampians, VIC', state: 'Victoria', country: 'Australia', center: { lat: -37.23, lng: 142.53 } },
  { name: 'Henty, VIC', state: 'Victoria', country: 'Australia', center: { lat: -37.85, lng: 141.64 } },
  { name: 'Gippsland, VIC', state: 'Victoria', country: 'Australia', center: { lat: -38.20, lng: 146.78 } },
