...
export async function PUT(request: Request, { params }: { params: Promise<{ id: string }> }) {
    ...
    try {
        ...
        return NextResponse.json({ success: true, message: `Location ${id} updated successfully` });
    } catch (error) {
...
export async function DELETE(request: Request, { params }: { params: Promise<{ id: string }> }) {
    ...
    try {
        ...
        return NextResponse.json({ success: true, message: `Location ${id} deleted successfully` });
    } catch (error) {
